...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  210 continue
      !--------------------------------------------------------------------
      ! Set v = v + wmult*w where wmult = - a(l) / vmax
      !--------------------------------------------------------------------
      do 300 l = l1, l2
         a(l)    = - a(l) / vmax
         indr(l) =   imax
         ! Compress storage if necessary
         minfre = n + 1
         nfree  = lena - lenL - lrow
         if (nfree .ge. minfre) go to 220
         call lu1rec(m, .true., luparm,lrow,ilast, lena, a, indr, lenr, 
     $               locr)
         nfree = lena - lenL - lrow
         if (nfree .lt. minfre) go to 970

  220    call lu7asv(m ,n ,indc(l), lenw,lw1,lw2,l,a(l), 
