...
MAKEFILE = adderRef_mex.mk

include adderRef_mex.mki


SRC_FILES =  \
	adderRef_data.c \
	adderRef_initialize.c \
	adderRef_terminate.c \
	adderRef.c \
	_coder_adderRef_info.c \
	_coder_adderRef_api.c \
	_coder_adderRef_mex.c \
	cAdd.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = adderRef_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/adderRef"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/adderRef/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/adderRef/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/adderRef/%.cu
	$(CC) $(CCFLAGS) "$<"
