...
MAKEFILE = carrqr_mex.mk

include carrqr_mex.mki
...
SRC_FILES =  \
	...
	carrqr_terminate.c \
	carrqr.c \
	_coder_carrqr_info.c \
	_coder_carrqr_api.c \
	_coder_carrqr_mex.c \
	ccarrqr.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = carrqr_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/carrqr"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/carrqr/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/carrqr/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/carrqr/%.cu
	$(CC) $(CCFLAGS) "$<"
