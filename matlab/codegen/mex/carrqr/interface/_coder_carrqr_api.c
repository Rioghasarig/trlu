 ...
 * _coder_carrqr_api.c
 *
 * Code generation for function '_coder_carrqr_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[10]
{
  ...
  void carrqr_api(const mxArray * const prhs[8])
{
  int32_T m;
  int32_T n;
  int32_T blkMax;
  ...
  carrqr(&st, m, n, blkMax, *A, lda, *jpvt, *tau, info);
}

/* End of code generation (_coder_carrqr_api.c) */
